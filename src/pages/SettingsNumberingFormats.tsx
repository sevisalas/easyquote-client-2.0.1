              ...
              <div className="pt-2 space-y-2">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setQuoteFormat({ ...quoteFormat, last_sequential_number: Math.max(0, parseInt(e.target.value) || 0) })}
                  />
              ...
              <div className="pt-2 space-y-2">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setOrderFormat({ ...orderFormat, last_sequential_number: Math.max(0, parseInt(e.target.value) || 0) })}
                  />
                  <p className="text-xs text-muted-foreground mt-1">
