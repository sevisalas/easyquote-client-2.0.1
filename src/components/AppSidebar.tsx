                        ...
                        <CollapsibleContent>
                          <SidebarMenuSub className="ml-2">
                            ...
                            {(isOrgAdmin || membership?.role === 'admin') && (
                              <SidebarMenuSubItem>
                                <SidebarMenuSubButton asChild isActive={currentPath === "/clientes/tarifas"} className="h-6 px-2">
                                  <NavLink to="/clientes/tarifas" className={getNavCls}>
                                    <Percent className="mr-2 h-4 w-4" />
                                    {!isCollapsed && <span>Tarifas</span>}
                                  </NavLink>
                                </SidebarMenuSubButton>
                              </SidebarMenuSubItem>
                            )}
