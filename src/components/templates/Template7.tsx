...
export default function Template7({ data }: Template7Props) {
  ...
  return (
    <div data-template7-page style={PAGE_STYLE}>
      ...
      {/* Cabecera: Solo Logo */}
      <div data-logo-container style={{ margin: 0, padding: '0 20px', display: 'flex', alignItems: 'flex-start', justifyContent: 'flex-start' }}>
        <img
          src="/assets/campillo-logo.png?v=20260224"
          alt="Campillo Nevado"
          style={{ height: '192px', width: 'auto', maxWidth: '880px', objectFit: 'contain', display: 'block' }}
