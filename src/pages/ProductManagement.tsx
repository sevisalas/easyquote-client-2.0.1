                ...
                <TableBody>
                  {filteredProducts.map((product) => (
                    <TableRow key={product.id}>
                      ...
                      <TableCell>
                        <span className="font-mono text-xs">{product.productName?.toLowerCase().replace(/\s+/g, '_') + '.xlsx'}</span>
                      </TableCell>
                      <TableCell>
                      ...
                      <TableCell>
                        {(() => {
                          const mapping = getProductMapping(product.id);
                          return mapping?.product_categories ? (
                            <Badge variant="secondary">{mapping.product_categories.name}</Badge>
                      ...
                      <TableCell>
                        <div className="flex gap-1">
                          ...
                          <Button variant="outline" size="sm" onClick={() => navigate(`/admin/productos/test?productId=${product.id}`)}>
