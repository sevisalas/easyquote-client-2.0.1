...
-- Eliminar las políticas actuales de quotes que usan ALL
DROP POLICY IF EXISTS "Admin can manage all organization quotes" ON quotes;
DROP POLICY IF EXISTS "Members can manage own quotes" ON quotes;
DROP POLICY IF EXISTS "Organization owners can manage quotes" ON quotes;
DROP POLICY IF EXISTS "Operador can view organization quotes" ON quotes;
