<template>
    <div>
        <div class="form-group">
            ...
            <input type="text" class="form-control" :class="validationClass" :id="fields.id" v-model="fields.currentValue" @blur="callAction($event.target)" :required="fields.valueRequired">
